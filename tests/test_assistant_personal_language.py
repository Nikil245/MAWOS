...
@pytest.mark.parametrize("question,expected_tool", [
    ...
    ("show me my attendance status", "get_attendance"),
    ("what is my attendance", "get_attendance"),
    ("show my attendance", "get_attendance"),
    ("attendance status", "get_attendance"),
    ("show attendance subject wise", "get_attendance"),
    ("show my attendance status with subject name", "get_attendance"),
    ("show my subject-wise attendance", "get_attendance"),
    ("show my attendance for each subject", "get_attendance"),
    ("attendance for each subject", "get_attendance"),
