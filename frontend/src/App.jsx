...
export default function App() { return <ErrorBoundary><Routes><Route path="/login" element={<LoginPage />} /><Route element={<ProtectedRoute />}><Route element={<AppLayout />}><Route index element={<HomeRedirect />} /><Route element={<RoleRoute roles={['student']} />}><Route path="student" element={<StudentDashboard />} /><Route path="student/timetable" element={<StudentTimetable />} /><Route path="student/scholarships" element={<StudentScholarships />} /></Route><Route element={<RoleRoute roles={['faculty', 'hod']} />}><Route path="faculty" element={<FacultyDashboard />} /><Route path="faculty/timetable" element={<FacultyTimetable />} /></Route><Route element={<RoleRoute roles={['faculty']} />}><Route path="faculty/scholarships" element={<FacultyScholarships />} /></Route><Route element={<RoleRoute roles={['hod']} />}><Route path="hod" element={<HodDashboard />} /><Route path="hod/scholarships" element={<HodScholarships />} /></Route><Route element={<RoleRoute roles={['principal', 'admin']} />}><Route path="principal" element={<PrincipalDashboard />} /></Route><Route element={<RoleRoute roles={['admin']} />}><Route path="admin" element={<AdminDashboard />} /></Route><Route path="assistant" element={<AssistantPage />} /><Route path="system" element={<SystemPage />} /><Route path="forbidden" element={<ForbiddenPage />} /><Route path="*" element={<NotFoundPage />} /></Route></Route><Route path="*" element={<Navigate to="/login" replace />} /></Routes></ErrorBoundary>; }
